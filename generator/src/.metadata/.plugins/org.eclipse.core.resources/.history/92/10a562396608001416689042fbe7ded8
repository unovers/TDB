...
import ch.heigvd.bachelor.crescenzio.generator.client.FieldForm.MainBox.CancelButton;
import ch.heigvd.bachelor.crescenzio.generator.client.FieldForm.MainBox.OkButton;
