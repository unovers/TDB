...
import ch.heigvd.bachelor.crescenzio.generator.client.forms.inputs.ServerForm.MainBox.CancelButton;
import ch.heigvd.bachelor.crescenzio.generator.client.forms.inputs.ServerForm.MainBox.HostnameField;
import ch.heigvd.bachelor.crescenzio.generator.client.forms.inputs.ServerForm.MainBox.OkButton;
import ch.heigvd.bachelor.crescenzio.generator.client.forms.inputs.ServerForm.MainBox.RootFolderField;
import ch.heigvd.bachelor.crescenzio.generator.client.forms.inputs.ServerForm.MainBox.ServerTypeField;
...
public class ServerForm extends AbstractForm {
   ...
   */
  public ServerForm(Project project) throws ProcessingException {
    super();
