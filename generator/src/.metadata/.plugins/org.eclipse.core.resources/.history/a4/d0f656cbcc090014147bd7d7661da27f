...
import ch.heigvd.bachelor.crescenzio.generator.client.forms.inputs.DatasetTypeForm.MainBox.CancelButton;
import ch.heigvd.bachelor.crescenzio.generator.client.forms.inputs.DatasetTypeForm.MainBox.DatasourceTypeField;
import ch.heigvd.bachelor.crescenzio.generator.client.forms.inputs.DatasetTypeForm.MainBox.OkButton;
 ...
 * @author Fabio
 */
public class DatasetTypeForm extends AbstractForm {

  /**
   * @throws org.eclipse.scout.commons.exception.ProcessingException
   */
  public DatasetTypeForm() throws ProcessingException {
    super();
  }
