...
import ch.heigvd.bachelor.crescenzio.generator.client.DatasetsTablePage.Table;
import ch.heigvd.bachelor.crescenzio.generator.shared.DatasetsTablePageData;

/**
 * @author Fabio
 */
@PageData(DatasetsTablePageData.class)
public class DatasetsTablePage extends AbstractExtensiblePageWithTable<Table> {
