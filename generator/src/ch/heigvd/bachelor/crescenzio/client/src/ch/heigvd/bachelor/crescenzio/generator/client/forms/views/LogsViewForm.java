...
import ch.heigvd.bachelor.crescenzio.generator.client.forms.views.LogsViewForm.MainBox.LogsField;
...
public class LogsViewForm extends AbstractForm {

  private Long LogsNr;

  public LogsViewForm() throws ProcessingException {
    super();
  }
  ...
  public void startModify() throws ProcessingException {
    startInternalExclusive(new LogsViewForm.ModifyHandler());
  }
